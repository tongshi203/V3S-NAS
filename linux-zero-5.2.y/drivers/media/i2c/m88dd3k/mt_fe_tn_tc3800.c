 ...
 * Modify			0.01.26		2016.03.08		Lei.Zhu
 * Modify			0.01.27		2016.08.23		Lei.Zhu
 * Modify			0.01.28		2017.01.25		Lei.Zhu
 *----------------------------------------------------------------------------
 *****************************************************************************/
...
// fix102281 end
	...
	if(handle->tuner_crystal == 24000)
	{
		if(((freq_KHz >= 51000) && (freq_KHz <= 53000)) ||
		   ...
		   ((freq_KHz > 737000) && (freq_KHz < 738000)))		// fix102281
		{
			CDIV = CDIV - 2;
		}
...
{
#if TC3800_ENABLE_PRINT
	tc3800_dbg_print(("TC3800 power on.\n"));
#endif
...
void _mt_fe_tn_lpf_cal_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	if((handle->tuner_application == 3) && (handle->tuner_freq == 198500) && (handle->tuner_custom_cfg == 1))
	{
		buf1 = 0x00;		// fix102281
	}
...
void mt_fe_tn_init_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	{
	#if TC3800_ENABLE_PRINT
		tc3800_dbg_print(("TC3800 initialize.\n"));
	#endif
	...
	//	handle->tuner_application		 = 0;
		...
		handle->tuner_mode				 = 0;
		handle->lt_gain_fix				 = 0;		// fix102281
		handle->lt_gain_code			 = 9;		// fix102281
		...
		handle->tuner_version			 = 128;
		handle->tuner_time				 = 17030615;
	...
	#if TC3800_ENABLE_PRINT
		tc3800_dbg_print(("TC3800 register 0x01 = %02x.\n", tmp));
	#endif
		switch(tmp)
		{
			case 0xb4:
...
{
	U8 buf = 0, buf1 = 0, buf2 = 0, buf3 = 0, buf4 = 0, buf5 = 0, buf6 = 0, buf7 = 0;			// fix102281
	U8 tWait1 = 0, tWait2 = 0;

#if TC3800_ENABLE_PRINT
	tc3800_dbg_print(("TC3800 set freq called. Tuner appl = %d\n", handle->tuner_application));
#endif
...
// fix102281 start
	if((handle->tuner_application == 3) && (handle->tuner_custom_cfg == 1))
	{
		if(handle->tuner_freq == 198500)
		{
			_mt_fe_tn_set_reg_bit_tc3800(handle, 0xb6, 0x01, 2, 2);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x01);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x00);
			...
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x0c);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x13);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x15);	//0x19
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x23);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x31);	//0x31
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x43);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x3f);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x3f);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x0f);
		...
		else
		{
			...
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x0c);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x13);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x19);	//0x19
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x23);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x31);	//0x31
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x43);
			_mt_fe_tn_set_reg_tc3800(handle, 0xb8, 0x3f);
...
// fix102281 end
	...
	if((handle->tuner_application == 1) || (handle->tuner_application == 3))		// fix102281
	{
...
#if TC3800_ENABLE_PRINT
	tc3800_dbg_print(("TC3800 set freq finished.\n"));
#endif
...
// fix102281 start
	...
	else if (handle->tuner_application == 3)
	{
		if(freq_KHz == 786000)
		{
			level -= 3;
...
void mt_fe_tn_get_diagnose_info_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U32* data1, U32* data2)
{
	...
	_mt_fe_tn_get_reg_tc3800(handle, 0x8a, &reg_data0);
	reg_data0 = (U8)(reg_data0&0x0f);
	_mt_fe_tn_get_reg_tc3800(handle, 0x8d, &reg_data1);
	reg_data1 = (U8)(reg_data1&0x3f);
	_mt_fe_tn_get_reg_tc3800(handle, 0x2a, &reg_data2);
	reg_data2 = (U8)(reg_data2&0x7f);
	_mt_fe_tn_get_reg_tc3800(handle, 0x2b, &reg_data3);
	reg_data3 = (U8)(reg_data3&0x7f);
	_mt_fe_tn_get_reg_tc3800(handle, 0x97, &reg_data4);
	reg_data4 = (U8)((reg_data4&0xe0)>>5);
	tc3800_dbg_print(("TC3800 - cg: %d, ci: %d, HFM: %d, HRM: %d, if: %d\n", reg_data0, reg_data1, reg_data2, reg_data3, reg_data4));

	_mt_fe_tn_get_reg_tc3800(handle, 0x9b, &reg_data0);
	reg_data0 = (U8)(reg_data0&0x3f);
	_mt_fe_tn_get_reg_tc3800(handle, 0xa7, &reg_data1);
	reg_data1 = (U8)(reg_data1&0x0f);
	_mt_fe_tn_get_reg_tc3800(handle, 0xab, &reg_data2);
	reg_data2 = (U8)(reg_data2&0x1f);
	_mt_fe_tn_get_reg_tc3800(handle, 0x1e, &reg_data3);
	reg_data3 = (U8)((reg_data3>>3)&0x07);
	_mt_fe_tn_get_reg_tc3800(handle, 0x7e, &reg_data4);
	tc3800_dbg_print(("TC3800 - tia: %d, bb: %d, vga: %d, dac: %d, fr: %d\n", reg_data0, reg_data1, reg_data2, reg_data3, reg_data4));

	_mt_fe_tn_get_reg_tc3800(handle, 0x31, &reg_data0);
	reg_data0 = (U8)(reg_data0&0x3f);
	_mt_fe_tn_get_reg_tc3800(handle, 0x33, &reg_data1);
	reg_data1 = (U8)(reg_data1&0x1f);
	_mt_fe_tn_get_reg_tc3800(handle, 0x72, &reg_data2);
	_mt_fe_tn_get_reg_tc3800(handle, 0x73, &reg_data3);
	value0 = (U32)reg_data3+(U32)((reg_data2&0x01)<<8);
	_mt_fe_tn_get_reg_tc3800(handle, 0x74, &reg_data4);
	value1 = (U32)reg_data4+(U32)((reg_data2&0x02)<<7);
	tc3800_dbg_print(("TC3800 - tia_cap: %d, bp_cap: %d, lna_cc: %d, cc_final: %d\n", reg_data0, reg_data1, value0, value1));

	_mt_fe_tn_get_reg_tc3800(handle, 0x01, &reg_data0);
	_mt_fe_tn_get_reg_tc3800(handle, 0xc5, &reg_data1);
	_mt_fe_tn_get_reg_tc3800(handle, 0xc6, &reg_data2);
	_mt_fe_tn_get_reg_tc3800(handle, 0xc8, &reg_data3);
	tc3800_dbg_print(("TC3800 - 0x01: 0x%x, 0xc5: 0x%x, 0xc6: 0x%x, 0xc8: 0x%x\n", reg_data0, reg_data1, reg_data2, reg_data3));

	_mt_fe_tn_get_reg_tc3800(handle, 0x65, &reg_data0);
	_mt_fe_tn_get_reg_tc3800(handle, 0x66, &reg_data1);
	_mt_fe_tn_get_reg_tc3800(handle, 0x67, &reg_data2);
	_mt_fe_tn_get_reg_tc3800(handle, 0x68, &reg_data3);
	_mt_fe_tn_get_reg_tc3800(handle, 0x69, &reg_data4);
	tc3800_dbg_print(("TC3800 - 0x65: 0x%x, 0x66: 0x%x, 0x67: 0x%x, 0x68: 0x%x, 0x69: 0x%x\n", reg_data0, reg_data1, reg_data2, reg_data3, reg_data4));

	_mt_fe_tn_get_reg_tc3800(handle, 0x6a, &reg_data0);
	_mt_fe_tn_get_reg_tc3800(handle, 0x6b, &reg_data1);
	_mt_fe_tn_get_reg_tc3800(handle, 0x6c, &reg_data2);
	tc3800_dbg_print(("TC3800 - 0x6a: 0x%x, 0x6b: 0x%x, 0x6c: 0x%x\n", reg_data0, reg_data1, reg_data2));
#endif
	return;
}
...
// fix102281 start
	if(DD_3800_handle->demod_cur_mode != MtFeType_CTTB)
	{
		if (handle->demod_dc_settings.demod_bandwidth == MtFeBandwidth_7M)
			TC3800_tuner_cfg.tuner_bandwidth = 7;
		else if (handle->demod_dc_settings.demod_bandwidth == MtFeBandwidth_6M)
			TC3800_tuner_cfg.tuner_bandwidth = 6;
		else 
			TC3800_tuner_cfg.tuner_bandwidth = 8;
	}
	else
	{
		if (handle->demod_ct_settings.demod_bandwidth == MtFeBandwidth_7M)
			TC3800_tuner_cfg.tuner_bandwidth = 7;
...
// fix102281 start
void mt_fe_tn_get_diagnose_info_tc3800_tc(MT_FE_Tuner_Handle_TC3800 handle, U32* data1, U32* data2)
{
	mt_fe_tn_get_diagnose_info_tc3800(&TC3800_tuner_cfg, data1, data2);
}
// fix102281 end
