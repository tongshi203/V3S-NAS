...
#define TC3800_ENABLE_PRINT		0

#if (TC3800_ENABLE_PRINT == 1)
	#define tc3800_dbg_print(str)				printf str
#else
	#define tc3800_dbg_print(str)
#endif
...
#endif
#endif
#define  MT_TC3800_CUSTOM_CONFIG	0	/*0: General;	1: Others */
...
typedef struct _MT_FE_TN_Device_Settings_TC3800
{
	...
	U8			lt_gain_fix;			// 0: LT gain auto; 1: LT gain fix.			// fix102281
	U8			lt_gain_code;			// If LT gain fix, set LT gain code.		// fix102281
