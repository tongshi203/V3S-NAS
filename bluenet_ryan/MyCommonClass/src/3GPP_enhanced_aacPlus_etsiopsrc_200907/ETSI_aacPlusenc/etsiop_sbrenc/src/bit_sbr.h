...
Word32 WriteEnvSingleChannelElement(struct SBR_HEADER_DATA    *sbrHeaderData,
...
Word32 WriteEnvChannelPairElement(struct SBR_HEADER_DATA    *sbrHeaderData,
                                  struct SBR_BITSTREAM_DATA *sbrBitstreamData,
...
Word32 CountSbrChannelPairElement (struct SBR_HEADER_DATA     *sbrHeaderData,
                                   struct SBR_BITSTREAM_DATA  *sbrBitstreamData,
                                   struct SBR_ENV_DATA        *sbrEnvDataLeft,
                                   struct SBR_ENV_DATA        *sbrEnvDataRight,
                                   struct COMMON_DATA         *cmonData);
