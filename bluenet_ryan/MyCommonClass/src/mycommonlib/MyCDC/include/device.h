...
/* by yuanlii@29bbs.net, 08/01/2005 10:27:14 */
#define HAVE_HZK_SUPPORT 	1
#define HZK_FONT_DIR		"/fonts"
#define HAVE_HUGENUM_SUPPORT	1	/* huge number */
#define HZK24_SMOOTH		1	/* if hzk24 need smooth */
#define HAVE_SHADOW_SUPPORT	1	/* green-black-transparent text */

#define SPEEDUP_DEVICE		1	/* = 1 allow speed-up drawing
						   only for em8510 STB */
...
typedef struct {
	...
	void	(*DrawText_S)(PMWFONT pfont, PSD psd, MWCOORD ax, MWCOORD ay,
			char *text, int cc);
...
/* by yuanlii@29bbs.net, 08/01/2005 10:30:14 */
#if	SPEEDUP_DEVICE
	void	(*DrawBlock)(PSD psd, MWCOORD x, MWCOORD y, MWPIXELVAL *c,
		       	MWCOORD width, MWCOORD height);
	void	(*ReadBlock)(PSD psd, MWCOORD x, MWCOORD y, MWPIXELVAL *c,
		       	MWCOORD width, MWCOORD height);
	void	(*DrawLine)(PSD psd, MWCOORD x, MWCOORD y, MWPIXELVAL *c, int nCount);
...
/* by yuanlii@29bbs.net, 07/29/2005 16:29:04 */
PSD	GdResetScreen(PSD psd);
/* by yuanlii@29bbs.net */
...
/* by yuanlii@29bbs.net, 07/11/2005 14:01:14 */
#define TRANS_COLOR	(MWRGB(0x11, 0x11, 0x11))
#if	HAVE_HUGENUM_SUPPORT
MWBOOL	GdLoadHugeNumber(int nHugeSize);
void	GdFreeHugeNumber(void);
void	GdDrawHugeNumber(PSD psd, MWCOORD x, MWCOORD y,
		char *szNumber, int nCount);
#endif/*HAVE_HUGENUM_SUPPORT*/
#if	HAVE_SHADOW_SUPPORT
void	GdText_S(PSD psd, MWCOORD x, MWCOORD y, char *szString, int nCount);
#endif/*HAVE_SHADOW_SUPPORT*/
/* by yuanlii@29bbs.net */
