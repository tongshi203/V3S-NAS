...
// by yuanlii@29bbs.net, 1/25/2005 16:53:19
...
// by yuanlii@29bbs.net
  ...
  if (count <= 0) {
	...
	clipresult = TRUE;
// by yuanlii@29bbs.net, 1/25/2005 16:53:51
...
// by yuanlii@29bbs.net
  ...
  for (rp = clipregion->rects; count-- > 0; rp++) {
	if ((x >= rp->left) && (y >= rp->top) && (x < rp->right)
		...
		clipresult = TRUE;
// by yuanlii@29bbs.net, 1/25/2005 16:54:12
//		GdCheckCursor(psd, x, y, x, y);
// by yuanlii@29bbs.net
		return TRUE;
	}
...
// by yuanlii@29bbs.net, 1/25/2005 16:54:58
