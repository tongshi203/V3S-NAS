 ...
 */
// by yuanlii@29bbs.net, 1/20/2005 15:55:47
...
BOOL PostThreadMessage(DWORD dwThreadId, UINT Msg, WPARAM wParam,
			LPARAM lParam);
...
HWND CreateWindowEx(DWORD dwExStyle, LPCSTR lpClassName,
...
// by yuanlii@29bbs.net, 1/31/2005 19:19:27
BOOL ClientToScreen(HDC hdc, LPPOINT lpPoint);
//BOOL ScreenToClient(HWND hwnd, LPPOINT lpPoint);
//int  MapWindowPoints(HWND hwndFrom, HWND hwndTo, LPPOINT lpPoints,
//			UINT cPoints);
// by yuanlii@29bbs.net

// by yuanlii@29bbs.net, 2/ 1/2005 11:56:41
...
#endif
BOOL MwPTINRECT(CONST RECT *lprc, POINT pt);
...
UINT SetTimer(HWND hwnd, UINT idTimer, UINT uTimeout,
