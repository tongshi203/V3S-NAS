...
#define DCX_DEFAULTCLIP      0x00100000L	/* microwin only*/
//#define DCX_DEFAULTCLIP      0x80000000L	/* microwin only*/

// by yuanlii@29bbs.net, 1/31/2005 17:10:04
// modified these functions break me away hwnd!
//HDC GetDCEx(HWND hwnd,HRGN hrgnClip,DWORD flags);
HDC GetDCEx(MWCOORD left, MWCOORD top, MWCOORD right, MWCOORD bottom, DWORD flags);
//HDC GetDC(HWND hWnd);
...
// by yuanlii@29bbs.net, 1/31/2005 17:35:12
// modified these functions break me away hwnd!
HDC  	BeginPaint(MWCOORD left, MWCOORD top, MWCOORD right, MWCOORD bottom);
BOOL  	EndPaint(HDC hdc);
// by yuanlii@29bbs.net
...
BOOL 	PolyPolygon(HDC hdc, CONST POINT *lpPoints, LPINT lpPolyCounts,
			int nCount);
...
BOOL 	TextOut(HDC hdc, int x, int y, LPCSTR lpszString, int cbString);
...
int 	DrawTextA(HDC hdc, LPCSTR lpString, int nCount, LPRECT lpRect,
			UINT uFormat);
...
BOOL 	DrawDIB(HDC hdc,int x, int y,PMWIMAGEHDR pimage); /* microwin*/
...
#define COLOR_BK_TRANSPARENT		6

DWORD 	GetSysColor(int nIndex);
COLORREF 	SetSysColor(int nIndex, COLORREF crColor);/* Microwindows only*/
...
VOID  SetRectRgn(HRGN hrgn, INT left, INT top, INT right, INT bottom );
...
BOOL  RectInRegion(HRGN hrgn, const RECT *rect );
