...
static int h264_mp4toannexb_filter(AVBitStreamFilterContext *bsfc,
    ...
    const uint8_t *buf_end_bak = buf_end;
    const uint8_t *buf_bak = buf;
    int buf_size_bak = buf_size;

    unsigned char aTmp[128];
