...
var ON = true; // 是否启用本功能
var ISNEW =true 
var Q = "querylist-format=js&entry=g_clist&id=0&key="/*tpa=http://counter.sina.com.cn/querylist?format=js&entry=g_clist&id=0&key=*/; // Counter接口
var U = "comment4.html-channel=_CHANNEL_&newsid=_NEWSID_&style=_STYLE_"/*tpa=http://comment4.news.sina.com.cn/comment/comment4.html?channel=_CHANNEL_&newsid=_NEWSID_&style=_STYLE_*/; // 留言板URL

//http://comment5.news.sina.com.cn/cmnt/count?format=json&newslist=gn:1-1-23729031:0,ty:6-12-5970313:0&callback=test12345 
var Q_new = "count-format=json&callback=counter_callback_new&newslist="/*tpa=http://comment5.news.sina.com.cn/cmnt/count?format=json&callback=counter_callback_new&newslist=*/; // Counter接口
var Q_new_1 = "count-format=json&newslist="/*tpa=http://comment5.news.sina.com.cn/cmnt/count?format=json&newslist=*/; // Counter接口
var U_new = "default.html-channel=_CHANNEL_&newsid=_NEWSID_&style=_STYLE_"/*tpa=http://comment5.news.sina.com.cn/comment/skin/default.html?channel=_CHANNEL_&newsid=_NEWSID_&style=_STYLE_*/; // 留言板URL
if (ISNEW){
	Q = Q_new;
	Q1 = Q_new_1;
	U = U_new
